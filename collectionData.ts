...
export const COLLECTION_DATA: CategoryCollection[] = [
  ...
  },
  {
    ...
    stages: [
      {
        stage: 1,
        images: ['لاعب 6', 'لاعب 5', 'ميسي', 'محمد ابو تريكه', 'كريستيانو رونالدو', 'محمد صلاح'],
        reward: { xp: 2500 }
      },
      {
        stage: 2,
        images: ['لاعب 7', 'لاعب 8', 'لاعب 9', 'لاعب 10', 'لاعب 11', 'لاعب 12'],
        reward: { xp: 5000 }
      },
      {
        stage: 3,
        images: ['لاعب 13', 'لاعب 14', 'لاعب 15', 'لاعب 16', 'لاعب 17', 'لاعب 18'],
