          ...
          {showLevelInfo && (
            ...
            >
              <motion.div 
                ...
                animate={{ scale: 1, y: 0 }}
                exit={{ scale: 0.9, y: 20 }}
                className="bg-white rounded-3xl p-6 max-w-md w-full relative overflow-hidden text-right shadow-2xl border-4 border-orange-400"
                onClick={e => e.stopPropagation()}
              >
                <button 
                  onClick={() => setShowLevelInfo(false)}
                  className="absolute top-4 left-4 w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 hover:bg-gray-200 transition-colors z-10"
                >
                  <X className="w-6 h-6" />
                </button>
                ...
                <div className="flex items-center gap-3 mb-6 flex-row-reverse">
                  ...
                  <h2 className="text-2xl font-black text-[#2D3436]">نظام المستويات</h2>
                </div>
                
                <div className="space-y-4 text-gray-600 font-bold max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
                  <p className="text-lg">كلما فزت في مباريات أكثر، كلما حصلت على XP وارتفع مستواك!</p>
                  
                  <div className="bg-orange-50 p-5 rounded-2xl border-2 border-orange-100">
                    <h3 className="text-xl font-black text-orange-600 mb-3 flex items-center gap-2 flex-row-reverse">
                      <Zap className="w-6 h-6" />
                      ميزة التخمين السريع
                    </h3>
                    <p className="text-sm leading-relaxed mb-4">
                      ميزة التخمين السريع تتيح لك محاولة تخمين الصورة قبل انتهاء الوقت.
                      كلما ارتفع مستواك، كلما تم تفعيل هذه الميزة بشكل أسرع في المباراة.
                    </p>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center bg-white p-3 rounded-xl border border-orange-100">
                        <span className="text-orange-500 font-black">بعد 150 ثانية</span>
                        <span className="text-gray-700">المستوى 1</span>
                      </div>
                      <div className="flex justify-between items-center bg-white p-3 rounded-xl border border-orange-100">
                        <span className="text-orange-500 font-black">بعد 78 ثانية</span>
                        <span className="text-gray-700">المستوى 25</span>
                      </div>
                      <div className="flex justify-between items-center bg-orange-500 p-3 rounded-xl text-white shadow-lg">
                        <span className="font-black">بعد 3 ثوانٍ فقط!</span>
                        <span className="font-black">المستوى 50</span>
                      </div>
                    </div>
                  </div>
                </div>
