...
import { Star, Trophy, Sparkles, HelpCircle, Type, Snowflake, SkipForward, Eye, X, Hash } from 'lucide-react';
...
const LEVEL_REWARDS: Record<number, { name: string; description: string; icon: any; color: string }> = {
  ...
  40: { name: 'عدد الكلمات', description: 'يكشف لك عدد كلمات صورة التخمين.', icon: Hash, color: 'text-indigo-500' },
